        ...
        @csrf
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  <div class="user-img mb-2" style="background-image: url(clientimage/{{$clients->image}})">
                  </div>
                  <div class="text pt-4">
                    <p class="mb-4">{{$clients->message}}</p>
                    <p class="name">{{$clients->name}}</p>
                    <span class="position">{{$clients->expatriate}}</span>
                  </div>
                </div>
              </div>
@endforeach
